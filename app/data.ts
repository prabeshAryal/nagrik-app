...
export const departmentHubs = [
  ...
  {
    id: "legal",
    name: "Legal, Notary & Courts",
    nepali: "कानूनी, नोटरी तथा अदालत",
    tagline: "Document translation, notarisation, consular attestation & court lists",
    badge: "Legal & Notary",
    iconName: "file" as const,
    theme: "navy" as const,
    serviceIds: ["translation", "notary", "attestation", "court", "digital-signature"],
  },
  {
    id: "health",
    name: "Health, Insurance & Medical",
    nepali: "स्वास्थ्य, बिमा तथा अस्पताल",
    tagline: "Health insurance enrolment, vaccine QR certification & hospital bookings",
    badge: "Health & Care",
    iconName: "shield" as const,
    theme: "red" as const,
    serviceIds: ["health-insurance", "vaccine", "hospital", "social-allowance"],
  },
  {
    id: "malpot",
    name: "Land & Malpot",
  ...
  {
    id: "business",
    name: "Company, Business & Tenders",
    nepali: "उद्योग, कम्पनी तथा ठेक्का",
    tagline: "Company registration (OCR), share transfers, e-GP bidder tenders & FDI",
    badge: "Business & Trade",
    iconName: "building" as const,
    theme: "teal" as const,
    serviceIds: ["company", "company-change", "egp", "tenders", "fdi", "eia"],
  },
  {
    id: "police",
  ...
  {
    id: "travel",
    name: "Travel, Tourism & Consular",
    nepali: "पर्यटन, भिसा तथा कन्सुलर",
    tagline: "Tourist visa extensions, trekking permits, expeditions & repatriation",
    badge: "Visa & Travel",
    iconName: "globe" as const,
    theme: "blue" as const,
    serviceIds: ["visa", "trek", "mountaineering", "repatriation"],
  },
  {
    id: "civic",
    name: "Civic & Hello Sarkar",
    nepali: "हेलो सरकार, निर्वाचन तथा उजुरी",
    tagline: "Hello Sarkar citizen complaints, voter registration & visitor passes",
    badge: "Civic & Governance",
    iconName: "help" as const,
    theme: "red" as const,
    serviceIds: ["grievance", "singha-durbar", "voter-register", "voter-check", "press-card"],
  },
];

export const featuredIds=["pcc","passport","vehicle-tax","noc","electricity","grievance","lalpurja","driving","translation","notary","health-insurance","company"];
