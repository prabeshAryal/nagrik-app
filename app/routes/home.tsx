...
export default function Home(){
 ...
 return <div className="page home-page">
  ...
  <section className="home-dashboard">
   <div className="citizen-card"><header><NepalFlag size={28}/><div><small>नेपाल सरकार · GOVERNMENT OF NEPAL</small><b>नागरिक परिचय</b></div><button className="icon-button card-eye" onClick={()=>setPrivacy(!privacy)} aria-label="Show or hide personal numbers"><Icon name={privacy?"eyeoff":"eye"}/></button></header><div className="citizen-body"><div className="citizen-photo"><img src="/avatar.jpg" alt="Prabin Shrestha" /><span><Icon name="shield" size={13}/> VERIFIED</span></div><div className="citizen-person"><small>FULL NAME</small><h2>Prabin Shrestha</h2><p>प्रबिन श्रेष्ठ</p><dl><div><dt>National ID</dt><dd>{privacy?"••• ••• •••":"983 472 810"}{!privacy&&<CopyButton value="983472810"/>}</dd></div><div><dt>Citizenship no.</dt><dd>{privacy?"•• •• •• •••••":"27-01-75-08421"}{!privacy&&<CopyButton value="27-01-75-08421"/>}</dd></div></dl></div></div><button className="citizen-share" onClick={()=>setShare(true)}><span className="qr-symbol">▦</span><span><b>Share verified identity</b><small>Choose fields · QR expires in 10 minutes</small></span><Icon name="chevron"/></button></div>
